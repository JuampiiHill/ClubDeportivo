    ...
    public partial class Login : Form
    {
        ...
        /*private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = ("Select * From usuario where username = '"+txtUser+"' and password = '"+txtPass+"'");
            ...
            } /*else
            {
                ...
                {
                    MessageBox.Show("El usuario o la contrase�a es incorrecto", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }*/
        private void btnLogin_Click(object sender, EventArgs e)
